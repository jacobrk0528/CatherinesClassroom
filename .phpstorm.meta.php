...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/jkrebs66/Documents/Personal/CatherinesClassroom/public/storage' => 'string',
...
'filesystems.links./home/jkrebs66/Documents/Personal/CatherinesClassroom/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'sanctum.csrf-cookie','home','contact.show','contact.submit',
'checkout.success','checkout.cancel','checkout','profile.edit','profile.update',
'profile.destroy','transaction.show','dashboard','units.index','units.create',
'units.store','units.edit','units.update','units.destroy','units.lessons.index',
'units.lessons.create','units.lessons.store','units.lessons.edit','units.lessons.update','units.lessons.destroy',
'units.lessons.files.index','units.lessons.files.create','units.lessons.files.store','units.lessons.files.edit','units.lessons.files.update',
'units.lessons.files.destroy','register','login',
...
'STRIPE_KEY','STRIPE_SECRET','VITE_APP_NAME',);
